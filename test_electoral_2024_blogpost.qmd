...
Publié le Mercredi 22 mai 2024 par Alexandre Irrthum. Update le 4 juin 2024.
...
Lorsque je l'ai alerté sur la valeur apparemment anormale de Défi pour cette question, Stefaan Walgrave m'a transmis le programme communiqué par Défi aux auteurs du Test. Le second panneau Défi_plus montre les fréquences calculées pour ce document, avec une fréquence beaucoup plus élevée pour le thème police/justice. L'explication de cette différence, c'est que ce document n'est pas le programme sensu stricto, mais le programme plus les notes thématiques, dont la longue note "Justice - 100 propositions".

On voit comment les choix des partis sur ce qu'ils communiquent exactement aux auteurs du Test peuvent avoir un effet considérable sur les poids calculés. Même le style dans lequel le document est rédigé aura une influence sur les poids, selon que le texte est plus ou moins riche en mots clés.

Les listes de mots clés elle-mêmes ne sont pas totalement objectives. Dans mes mots clés immigration/intégration, je n'ai pas inclus de mots liés à la religion, considérant que ces mots se rattachent au thème laïcité/cultes. Mais d'autres choix sont possibles, avec un impact sur les scores calculés.

Enfin, le rattachement d'une question à un thème ou un autre est aussi subjectif et va modifier son poids. La question sur la place des cyclistes sur les routes est-elle purement une question transports/mobilité, ou est-elle aussi une question sur l'environnement ?
...
Voici une liste de propositions pour un futur Test Électoral:
...
- simplifier, voire abandonner le système de pondération actuel.
...
* 29 mai 2024
    + ajouté l'analyse des fréquences des mots clés dans les programmes.
    + supprimé l'histogramme correspondant à la matrice des poids.
* 4 juin 2024
    + ajouté l'explication de la valeur aberrante (outlier) pour Défi
    + ajouté les propositions pour les tests futurs
    + réorganisé le texte